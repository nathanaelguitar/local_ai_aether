...
function messageFor(
  ...
  const body = [
    "Hi,",
    "",
    "Your one-time Founding Member contribution has been received, and your place in the first CanopyChat community is reserved.",
    "",
    "The iPhone beta is live. You can join now:",
    ...
    "",
    "Your three-month Premium period begins when you activate your beta access. This was a one-time payment and does not start a subscription or authorize future charges.",
    "",
    "If you need help, reply to this email or contact support@canopychat.app.",
    "",
    "Welcome to CanopyChat,",
    "The CanopyChat team",
  ].join("\n");
  const raw = [
    ...
    `To: ${recipient}`,
    `Reply-To: ${sender}`,
    "Subject: Your CanopyChat Founding Membership",
    "MIME-Version: 1.0",
