    ...
    var body: some View {
                ...
                VStack(spacing: 0) {
                    ...
                    HStack {
                        Text("Your Grove")
                            ...
                            .foregroundColor(state.isDarkTheme ? AetherColors.oakCream : AetherColors.oakDark)
                        Spacer()
        ...
        .sheet(isPresented: $showNewChat) {
            NewChatSheet(
                ...
                onUpdatePersona: { id, name, description, instructions in
                    state.updateCustomPersona(id: id, name: name, description: description, instructions: instructions)
                },
                onDeletePersona: { persona in
                    state.deleteCustomPersona(persona)
                },
